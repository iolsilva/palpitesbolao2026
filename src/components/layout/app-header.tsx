...
export default function AppHeader({ userName, userRole }: AppHeaderProps) {
  ...
  const navItems = [
    ...
    { href: '/rodada', label: 'Registrar Palpites' },
    { href: '/meus-palpites', label: 'Meus Palpites' },
    { href: '/palpites-da-rodada', label: 'Palpites dos caras' },
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 text-white backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 py-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 flex-col gap-1">
            <Link href="/dashboard" className="truncate text-2xl font-black tracking-tight text-white">
